...
impl<'a> PlayerEmbed<'a> {
    pub fn to_embed(&self) -> CreateEmbed {
        match self {
            ...
            PlayerEmbed::NoSongPlaying => CreateEmbed::new()
                .color(Color::DARK_RED)
                .title("🚫  No song playing")
                .description("No song is currently playing."),
            PlayerEmbed::IsStopped => CreateEmbed::new()
                .color(Color::DARK_RED)
                .title("⏹️  Playback stopped")
                .description("The playback has been stopped."),
            PlayerEmbed::Stopped => CreateEmbed::new()
                .color(Color::DARK_RED)
                .title("⏹️  Playback stopped")
                .description("The playback has been stopped."),
            PlayerEmbed::Paused(track) => CreateEmbed::new()
                .color(Color::ORANGE)
                .title("⏸️  Paused")
                .description(track_description(track)),
            PlayerEmbed::Resumed(track) => CreateEmbed::new()
                .color(Color::DARK_GREEN)
                .title("▶️  Resumed")
                .description(track_description(track)),
            PlayerEmbed::Volume(volume) => CreateEmbed::new()
                .color(Color::DARK_BLUE)
                .title("🔊  Volume")
            ...
            PlayerEmbed::Skipped(amount) => CreateEmbed::new()
                .color(Color::DARK_BLUE)
                .title("⏭️  Skipped")
                .description(format!("Skipped {} track(s).", amount)),
            PlayerEmbed::Shuffled => CreateEmbed::new()
                .color(Color::DARK_BLUE)
                .title("🔀  Shuffle")
            ...
            PlayerEmbed::SearchCancelled => CreateEmbed::new()
            ...
            PlayerEmbed::HistoryEmpty => CreateEmbed::new()
                .color(Color::DARK_RED)
                .title("📜  No history")
                .description("No tracks have been played yet."),
            PlayerEmbed::Downloading(url) => CreateEmbed::new()
                .color(Color::DARK_BLUE)
                .title("⬇️  Downloading")
            ...
            PlayerEmbed::DownloadFailed(reason) => CreateEmbed::new()
                .color(Color::DARK_RED)
            ...
            PlayerEmbed::LocalRenamed { old, new } => CreateEmbed::new()
                .color(Color::DARK_GREEN)
                .title("✏️  Renamed")
