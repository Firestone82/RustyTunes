...
impl<'a> PlayerEmbed<'a> {
    pub fn to_embed(&self) -> CreateEmbed {
        match self {
            ...
            PlayerEmbed::NoSongPlaying => CreateEmbed::new().color(Color::DARK_RED).title("🚫  No song playing").description("No song is currently playing."),
            PlayerEmbed::IsStopped => CreateEmbed::new().color(Color::DARK_RED).title("⏹️  Playback stopped").description("The playback has been stopped."),
            PlayerEmbed::Stopped => CreateEmbed::new().color(Color::DARK_RED).title("⏹️  Playback stopped").description("The playback has been stopped."),
            PlayerEmbed::Paused(track) => CreateEmbed::new().color(Color::ORANGE).title("⏸️  Paused").description(track_description(track)),
            PlayerEmbed::Resumed(track) => CreateEmbed::new().color(Color::DARK_GREEN).title("▶️  Resumed").description(track_description(track)),
            PlayerEmbed::Volume(volume) => CreateEmbed::new().color(Color::DARK_BLUE).title("🔊  Volume").description(format!("Volume is set to {}%.", volume)),
            PlayerEmbed::VolumeChanged(volume) => CreateEmbed::new()
                .color(Color::DARK_BLUE)
            ...
            PlayerEmbed::NormalizeState(on) => {
                ...
                CreateEmbed::new().color(Color::DARK_BLUE).title(title).description(body)
            }
            ...
            PlayerEmbed::Skipped(amount) => CreateEmbed::new().color(Color::DARK_BLUE).title("⏭️  Skipped").description(format!("Skipped {} track(s).", amount)),
            PlayerEmbed::Shuffled => CreateEmbed::new().color(Color::DARK_BLUE).title("🔀  Shuffle").description("Queue has been shuffled."),
            ...
            PlayerEmbed::SearchExpired => CreateEmbed::new()
                .color(Color::DARK_RED)
                .title("🚫  Search expired")
                .description("The search has expired. Please try again."),
            PlayerEmbed::SearchCancelled => CreateEmbed::new().color(Color::DARK_GREY).title("✖  Search cancelled").description("No track was added to the queue."),
            PlayerEmbed::NoResults(query) => CreateEmbed::new()
            ...
            PlayerEmbed::PlaybackErrorEmbed(message) => CreateEmbed::new().color(Color::DARK_RED).title("🚫  Playback error").description(message.clone()),
            ...
            PlayerEmbed::History(history) => {
                let mut embed = CreateEmbed::new().color(Color::DARK_BLUE).title("📜  Recently played").description("Pick a number to replay a track:");
            ...
            PlayerEmbed::HistoryEmpty => CreateEmbed::new().color(Color::DARK_RED).title("📜  No history").description("No tracks have been played yet."),
            PlayerEmbed::Downloading(url) => CreateEmbed::new().color(Color::DARK_BLUE).title("⬇️  Downloading").description(format!("Fetching `{}`…", url)),
            PlayerEmbed::Downloaded(name) => CreateEmbed::new()
                .color(Color::DARK_GREEN)
                .title("✅  Downloaded")
                .description(format!("Saved **{}** to local library.", name)),
            PlayerEmbed::DownloadFailed(reason) => CreateEmbed::new().color(Color::DARK_RED).title("🚫  Download failed").description(reason.clone()),
            ...
            PlayerEmbed::LocalNoMatch(query) => CreateEmbed::new()
                .color(Color::DARK_GOLD)
                .title("🔎  No local match")
                .description(format!("No saved track matches **{}**.", query)),
            PlayerEmbed::LocalRemoved(name) => CreateEmbed::new()
                .color(Color::DARK_GREEN)
                .title("🗑️  Removed")
                .description(format!("Deleted **{}** from local library.", name)),
            PlayerEmbed::LocalRenamed { old, new } => CreateEmbed::new().color(Color::DARK_GREEN).title("✏️  Renamed").description(format!("**{}** → **{}**", old, new)),
...
fn local_listing_embed(title: &str, description: &str, files: &[PathBuf]) -> CreateEmbed {
    let mut embed = CreateEmbed::new().color(Color::DARK_BLUE).title(title.to_string()).description(description.to_string());
